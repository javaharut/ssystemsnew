 ...
 * @property string $layoutPath The root directory of layouts files. Defaults to 'moduleDir/views/layouts' where
...
class CWebModule extends CModule
{
	...
	/**
	 * @var mixed the layouts that is shared by the controllers inside this module.
	 * If a controller has explicitly declared its own {@link CController::layouts layouts},
	 * this property will be ignored.
	 * If this is null (default), the application's layouts or the parent module's layouts (if available)
	 * will be used. If this is false, then no layouts will be used.
	 */
	public $layout;
	/**
	...
	/**
	 * @return string the root directory of layouts files. Defaults to 'moduleDir/views/layouts' where
	 * moduleDir is the directory containing the module class.
	 */
	...
	/**
	 * @param string $path the root directory of layouts files.
	 * @throws CException if the directory does not exist.
	 */
	public function setLayoutPath($path)
	{
		if(($this->_layoutPath=realpath($path))===false || !is_dir($this->_layoutPath))
			throw new CException(Yii::t('yii','The layouts path "{path}" is not a valid directory.',
				array('{path}'=>$path)));
	}
