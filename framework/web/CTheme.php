...
class CTheme extends CComponent
{
	...
	/**
	 * Finds the layouts file for the specified controller's layouts.
	 * @param CController $controller the controller
	 * @param string $layoutName the layouts name
	 * @return string the layouts file path. False if the file does not exist.
	 */
