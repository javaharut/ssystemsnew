 ...
 * @property string $layoutPath The root directory of layouts files. Defaults to 'protected/views/layouts'.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.web
 * @since 1.0
...
class CWebApplication extends CApplication
{
	...
	/**
	 * @var mixed the application-wide layouts. Defaults to 'main' (relative to {@link getLayoutPath layoutPath}).
	 * If this is false, then no layouts will be used.
	 */
	public $layout='main';
	/**
	...
	/**
	 * @return string the root directory of layouts files. Defaults to 'protected/views/layouts'.
	 */
