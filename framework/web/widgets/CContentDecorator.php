 ...
 *
 * CContentDecorator is mostly used to implement nested layouts, i.e., a layouts
 * is embedded within another layouts. {@link CBaseController} defines a pair of
...
class CContentDecorator extends COutputProcessor
{
	 ...
	 * If this property is null (default value), the default layouts will be used as
	 * the decorative view. Note that if the current controller does not belong to
	 * any module, the default layouts refers to the application's {@link CWebApplication::layouts default layouts};
	 * If the controller belongs to a module, the default layouts refers to the module's
	 * {@link CWebModule::layouts default layouts}.
	 */
	public $view;
	/**
