 ...
 *
 * A theme is a collection of view/layouts files and resource files
 * (e.g. css, image, js files). When a theme is active, {@link CController}
 * will look for the specified view/layouts under the theme folder first.
 * The corresponding view/layouts files will be used if the theme provides them.
 * Otherwise, the default view/layouts files will be used.
 *
 ...
 * Web accessible, please make sure the view/layouts files are protected from Web access.
 *
