...
class CViewAction extends CAction
{
	...
	/**
	 * @var mixed the name of the layouts to be applied to the views.
	 * This will be assigned to {@link CController::layouts} before the view is rendered.
	 * Defaults to null, meaning the controller's layouts will be used.
	 * If false, no layouts will be applied.
	 */
	public $layout;
	/**
