...
<script>
    jQuery(document).ready(function ($) {
        ...
        function ScaleSlider() {
            ...
            if (parentWidth)
                jssor_sliderb.$SetScaleWidth(Math.min(parentWidth, 960));
            else
...
<div id="sliderb_container" style="position: relative; width: 960px;
...
<div align="center">
    <div class="wrapper col3">
        ...
        <div id="breadcrumb" style="text-align: left;">
            <ul>
                <li class="current"><a href="<?=$baseUrl?>"><?= Yii::t('language','main')?></a></li>    </ul>
        </div>
