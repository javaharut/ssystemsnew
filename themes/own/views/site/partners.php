...
<div class="wrapper col3">
    ...
    <div class="container">
        <?php foreach($partners as $partner):?>
            <div class="product">
                <div class="img_wrap"><img class="product_img" src="<?=$baseUrl?>/images/partner/<?=$partner->id?>.png"/></div>
                <div class="product_title"><?=$partner->ctitle?></div>
                <div class="clear"></div>
                <a href="<?=$baseUrl.'/'.Yii::t('language','prefix').'/site/partners/'.$partner->id ?>"><div class="more"><?=Yii::t('language','more')?></div></a>
            </div>
        <?php endforeach;?>
    </div>
